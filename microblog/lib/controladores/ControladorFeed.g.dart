...
mixin _$ControladorFeed on _ControladorFeedBase, Store {
  ...
  bool get habilitadoAPostar => (_$habilitadoAPostarComputed ??= Computed<bool>(
          ...
          name: '_ControladorFeedBase.habilitadoAPostar'))
      .value;

  final _$mPostagensAtom = Atom(name: '_ControladorFeedBase.mPostagens');
  ...
  final _$mStatusConsultaFeedAtom =
      Atom(name: '_ControladorFeedBase.mStatusConsultaFeed');
  ...
  final _$conteudoPublicacaoAtom =
      Atom(name: '_ControladorFeedBase.conteudoPublicacao');
